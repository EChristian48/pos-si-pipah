     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="integer" name="id_transaksi" class="form-control" placeholder="Id Transaksi">
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="integer" name="id_user" class="form-control" placeholder="Id User">
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Jumlah Beli:</strong>
                <input type="integer" name="jumlah_beli" class="form-control" placeholder="Jumlah Beli">
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Total Harga:</strong>
                <input type="float" name="total_harga" class="form-control" placeholder="Total Harga">
            </div>
